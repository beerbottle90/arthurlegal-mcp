...
CC BY-SA 4.0. Signed oil, gas and mining contracts are a primary source for energy
and natural-resources legal work.
...
_DEFAULT_UA = "arthurlegal-resourcecontracts/0.1 (+legal-research; stdlib-urllib)"
